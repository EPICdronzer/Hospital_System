        ...
        <div style={{ position: "relative" }}>
              ...
              {visibleDoctors.map((doc, i) => {
                ...
                return (
                  <Link
                    ...
                    style={{ cursor: "pointer", height: CARD_HEIGHT, position: "relative", borderRadius: 4, overflow: "hidden", display: "block", textDecoration: "none" }}
                  >
                    {/* Photo layer */}
                    <div style={{
          ...
          <div style={{ backgroundColor: "#0d1b4b", paddingTop: 32, paddingBottom: 48 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16 }}>
              ...
              {/* Dots with Wide-Pill for active dot */}
